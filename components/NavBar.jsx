      ...
      <header className="header-page" itemScope="itemscope">
        <div className="head-container">
          <div className="container__item">
            ...
            <nav
              id="id-menu"
              className={movilMenuOpen ? "item__menu open" : "item__menu"}
            >
              <ul className="menu_ul">
                <li className="ul__li">
                  <Link
                    href="/"
                    onClick={() => {
                      activeBar(0), menuMovilClose();
                    }}
                    className={selected === 0 ? "li__text active" : "li__text"}
                  >
                    Inicio
                  </Link>
                </li>
                <li className="ul__li">
                  <Link
                    href="/nosotros"
                    onClick={() => {
                      activeBar(1), menuMovilClose();
                    }}
                    className={selected === 1 ? "li__text active" : "li__text"}
                  >
                    Nosotros
                  </Link>
                </li>
                <li className="ul__li">
                  <Link
                    href="/descargas"
                    onClick={() => {
                      activeBar(2), menuMovilClose();
                    }}
                    className={selected === 2 ? "li__text active" : "li__text"}
                  >
                    Descargas
                  </Link>
                </li>
                ...
                <li className="ul__li">
                  <Link
                    href="/servicios"
                    onClick={() => {
                      activeBar(4), menuMovilClose();
                    }}
                    className={selected === 4 ? "li__text active" : "li__text"}
                  >
                    Servicios
                  </Link>
                </li>
                <li className="ul__li">
                  <Link
                    href="/requisitos"
                    onClick={() => {
                      activeBar(5), menuMovilClose();
                    }}
                    className={selected === 5 ? "li__text active" : "li__text"}
                  >
                    Requisitos
                  </Link>
                </li>
                ...
                <div className="action__control">
                  <div className="control__container">
                    <div className="container__text cl-session">
                      <Link href="/consulta" className="li__text">
                        Consulta
                      </Link>
                    </div>
                    <div className="container__icon">
                      <Link href="/consulta" className="material-icons">
                        search
                      </Link>
                    </div>
                  </div>
